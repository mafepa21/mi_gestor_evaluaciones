...
4. Si hay fallos de compilación:
   - Revisa el archivo de log correspondiente: `/tmp/mac_build.log` o `/tmp/ios_build.log`.
...
- **Cachés corruptas o DerivedData conflictivo**: Si ves errores extraños que no parecen relacionados con tu código, limpia el DerivedData temporal borrando los directorios `/tmp/MiGestorMacBuildVerify` o `/tmp/MiGestorIOSBuildVerify` y vuelve a ejecutar.
