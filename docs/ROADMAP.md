...
- Planificacion: sesiones, situaciones de aprendizaje y continuidad docente.
  ...
  Avance: Planificación macOS reutiliza el toolbar y las vistas iPadOS para mantener una estética uniforme; sus botones flotantes usan `.glass`/`.glassProminent` y las pestañas se agrupan con `GlassEffectContainer` en iOS/macOS 26, con fallback material.
