...
class NotebookCellsRepositorySqlDelight(
    ...
    override suspend fun saveCell(
        ...
        db.appDatabaseQueries.upsertNotebookCellEntry(
            ...
            value_bool = boolValue?.let { if (it) 1L else 0L },
            value_icon = iconValue,
            value_ordinal = ordinalValue,
            display_value = null,
            observed_at_epoch_ms = null,
            competency_criteria_ids_csv = "",
            effective_weight = null,
            counts_toward_average = null,
            note = note,
            color_hex = colorHex,
            attachment_uris_csv = attachmentUris.joinToString("|"),
            author_user_id = authorUserId,
            created_at_epoch_ms = now,
            updated_at_epoch_ms = now,
            associated_group_id = associatedGroupId,
            device_id = deviceId,
            sync_version = syncVersion,
        )
    }
