...
compose.desktop {
    application {
        mainClass = "com.migestor.desktop.MainKt"
        jvmArgs += listOf(
        ...
        nativeDistributions {
            ...
            packageName = "MiGestor"
            packageVersion = "1.0.0"
            description = "Plataforma educativa de gestion de evaluaciones"
            vendor = "Mario Fernandez"

            modules("java.sql", "java.naming", "java.logging", "java.management", "java.prefs", "jdk.httpserver", "jdk.crypto.ec")

            macOS {
                iconFile.set(project.file("src/jvmMain/resources/icon.icns"))
                bundleID = "com.migestor.app"
                packageVersion = "1.0.0"
            }
        }
    }
