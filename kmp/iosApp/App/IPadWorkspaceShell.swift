...
private struct WorkspaceCreateSheetScaffold<Content: View>: View {
    let title: String
    let subtitle: String
    let systemImage: String
    let canSave: Bool
...
private struct WorkspaceCreateSheetHero: View {
    let title: String
    let subtitle: String
    let systemImage: String
...
private struct WorkspaceCreateTextField: View {
    let title: String
...
private struct WorkspaceCreateMultilineField: View {
    let title: String
    let placeholder: String
    @Binding var text: String
